...
sealed class GyroInputTester : MonoBehaviour
{
    ...
    public void XPressed(InputAction.CallbackContext ctx)
    {
        SerialHandler.doReset = true;
    }
    ...
    void Update()
    {
        ...
        //Debug.Log("AccX: " + accX + ", AccY: " + accY + ", AccZ: " + accZ + ", RotX: " + rotX + ", RotY: " + rotY + "RotZ: " + rotZ);
    }
    #endregion
}
